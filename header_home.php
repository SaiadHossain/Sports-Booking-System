      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
           <br><br>
            <li><a href="Booking.php"><i class="fa fa-bar-chart-o"></i> Book Slot</a></li>
            <li><a href="update.php"><i class="fa fa-table"></i> Update Profile</a></li>
            <li><a href="sports.php"><i class="fa fa-edit"></i> Sports Facility</a></li>
            <li><a href="profile.php"><i class="fa fa-table"></i> Check Profile</a></li>
            <li><a href="history.php"><i class="fa fa-table"></i> Check Booking History</a></li>
            </ul>
